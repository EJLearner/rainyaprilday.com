    ...
    <>
      ...
      <div className="about-paragraph">
        <p>
          ...
          April Day upholds that genre storytelling, particularly horror, has a place in cinematic expression. Our work
          embraces the belief that even the most ordinary experiences can become unique and powerful stories when told
          from our diverse perspectives.
        </p>
